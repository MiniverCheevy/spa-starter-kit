...
namespace Fernweh.Core.Operations.Lists
{
    ...
    {
        public async Task<List<IListItem>> GetList(FernwehContext context, Lists list, bool includeInactive = false)
        {
        ...
        public async Task<ListsResponse> GetLists(FernwehContext context, ListsRequest request)
        {
            Type enumType=null;
