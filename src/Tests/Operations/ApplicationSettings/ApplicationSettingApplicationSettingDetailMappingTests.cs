...
{
    [TestClass]
    public class ApplicationSettingApplicationSettingDetailMappingTests
    {
        ...
        {
            var testHelper =
            new MappingTesterHelper<ApplicationSetting, ApplicationSettingDetail>();
            var source = arrange();
            var message = source.ToApplicationSettingDetail();
