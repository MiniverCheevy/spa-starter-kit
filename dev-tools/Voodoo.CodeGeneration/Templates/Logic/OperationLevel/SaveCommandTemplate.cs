...
namespace Voodoo.CodeGeneration.Templates.Logic.OperationLevel
{
    ...
    public partial class SaveCommandTemplate : SaveCommandTemplateBase
    {
        /// <summary>
...
if(this.File.HasContext){
            ...
            this.Write("(");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.File.Type.DetailQueryMessageName));
            this.Write(@" request) : base(request)
        {
        }      	  
...
if(this.File.HasContext && this.File.Type.HasId){
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class SaveCommandTemplateBase
    {
        #region Fields
