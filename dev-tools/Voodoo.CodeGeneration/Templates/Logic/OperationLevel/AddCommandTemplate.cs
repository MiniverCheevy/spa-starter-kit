...
namespace Voodoo.CodeGeneration.Templates.Logic.OperationLevel
{
    ...
    public partial class AddCommandTemplate : AddCommandTemplateBase
    {
        /// <summary>
...
");
            ...
            Write("\r\n{\r\n\t[Rest(Verb.Post, RestResources.");
            Write(ToStringHelper.ToStringWithCulture(File.Type.Name));
            Write(")]\r\n    public class ");
            Write(ToStringHelper.ToStringWithCulture(File.Name));
            Write(" :CommandAsync<");
            Write(ToStringHelper.ToStringWithCulture(File.Type.DetailQueryMessageName));
            Write(", NewItemResponse>\r\n    {\r\n \r\n\t\t");
            if (File.HasContext)
            {
                Write("protected ");
		...
		protected override async Task<NewItemResponse> ProcessRequestAsync()
        {
            ...
            var idRow = File.Type.HasId ? "response.NewItemId = model.Id;" : "//response.NewItemId = model.Id;";

            Write(ToStringHelper.ToStringWithCulture(idRow));
            Write("\r\n\t\t\tresponse.Message = ");
            Write(ToStringHelper.ToStringWithCulture(File.Type.Name));
            Write("Messages.AddOk;\r\n\t\t\treturn response;\r\n        }\r\n    }\r\n}\r\n");
    ...
    /// </summary>
    [GeneratedCode("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class AddCommandTemplateBase
    {
        #region Fields
