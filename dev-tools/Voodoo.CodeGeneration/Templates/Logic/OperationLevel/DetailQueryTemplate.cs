...
namespace Voodoo.CodeGeneration.Templates.Logic.OperationLevel
{
    ...
    public partial class DetailQueryTemplate : DetailQueryTemplateBase
    {
        /// <summary>
...
");
            ...
            Write(" : QueryAsync<IdRequest,Response<");
            ...
            Write("\t\t\t");
            if (File.Type.HasDetailFlag)
            {
                Write("\t\t\t response.Data = model.To");
                Write(ToStringHelper.ToStringWithCulture(File.Type.Name));
                Write("Detail();\r\n\t\t\t ");
            }
            else
    ...
    /// </summary>
    [GeneratedCode("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class DetailQueryTemplateBase
    {
        #region Fields
