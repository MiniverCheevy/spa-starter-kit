...
foreach (var item in File.UsingStatements){
            ...
            this.Write(" \r\n\t\t{\r\n\t\t\tpublic const string AddOk= \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.File.FriendlyName));
            this.Write(" added successfully.\";\r\n\t\t\tpublic const string UpdateOk= \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.File.FriendlyName));
            this.Write(" updated successfully.\";\r\n\t\t\tpublic const string DeleteOk= \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.File.FriendlyName));
            this.Write(" deleted successfully.\";\r\n\t\t\tpublic const string NotFound = \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.File.FriendlyName));
            this.Write(" not found.\";\r\n\r\n\t\t");
foreach (var item in File.Errors){
            this.Write("\t");
            this.Write(this.ToStringHelper.ToStringWithCulture(item));
            this.Write("\r\n\t\t");
}
