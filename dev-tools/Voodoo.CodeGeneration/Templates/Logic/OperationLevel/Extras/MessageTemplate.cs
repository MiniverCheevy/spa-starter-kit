...
namespace Voodoo.CodeGeneration.Templates.Logic.OperationLevel.Extras
{
    ...
    public partial class MessageTemplate : MessageTemplateBase
    {
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            Write("))]\r\n    public class ");
            Write(ToStringHelper.ToStringWithCulture(File.Type.MessageName));
            Write("\r\n    {\r\n        ");
            foreach (var item in File.Type.MessageProperties)
            {
                Write("\t\t");
                foreach (var attr in item.Property.Attributes)
                {
                    Write(ToStringHelper.ToStringWithCulture(attr.Text));
                    Write("\r\n\t\t");
                }
                Write("\tpublic ");
                Write(ToStringHelper.ToStringWithCulture(item.StringifiedTypeName));
                Write(" ");
                Write(ToStringHelper.ToStringWithCulture(item.PropertyName));
                Write(" {get;set;}\r\n\r\n\t\t\t");
            }
            Write("\r\n\t\t\r\n    }\r\n\t");
            if (File.HasDetail)
            {
                ...
                Write(ToStringHelper.ToStringWithCulture(File.Type.Name));
                Write("))]\r\n\tpublic class ");
                Write(ToStringHelper.ToStringWithCulture(File.Type.DetailName));
                Write("\r\n\t{\r\n\t");
                foreach (var item in File.Type.DetailMessageProperties)
                {
                    Write("\t\t");
                    foreach (var attr in item.Property.Attributes)
                    {
