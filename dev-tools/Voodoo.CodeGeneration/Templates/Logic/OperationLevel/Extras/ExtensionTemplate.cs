    ...
    public partial class ExtensionTemplate : ExtensionTemplateBase
    {
        ...
        public virtual string TransformText()
        {
            ...
            if (File.HasContext)
            {
                ...
                Write("Repository ");
                Write(ToStringHelper.ToStringWithCulture(File.Type.Name));
                Write("Repository(this ");
                Write(ToStringHelper.ToStringWithCulture(File.ContextName));
                Write(" context)\r\n        {\r\n           return new ");
                Write(ToStringHelper.ToStringWithCulture(File.Type.Name));
                Write("Repository(context);\r\n        }\r\n\r\n\t\t");
            }
            Write("\r\n\r\n\t\t");
            foreach (var map in File.Mappings)
            {
                Write("\t\tpublic static ");
                Write(ToStringHelper.ToStringWithCulture(map.MessageTypeName));
                Write(" To");
                Write(ToStringHelper.ToStringWithCulture(map.MessageTypeName));
                Write("(this ");
                Write(ToStringHelper.ToStringWithCulture(map.ModelTypeName));
                Write(" model)\r\n        {\r\n           var message = to");
                Write(ToStringHelper.ToStringWithCulture(map.MessageTypeName));
                Write("(model, new ");
                Write(ToStringHelper.ToStringWithCulture(map.MessageTypeName));
