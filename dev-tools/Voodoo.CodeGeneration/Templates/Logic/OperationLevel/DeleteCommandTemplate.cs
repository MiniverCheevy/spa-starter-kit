...
namespace Voodoo.CodeGeneration.Templates.Logic.OperationLevel
{
    ...
    public partial class DeleteCommandTemplate : DeleteCommandTemplateBase
    {
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            Write("\t\tprotected IValidator validator = ValidationManager.GetDefaultValidatitor();\r\n\r\n" +
                  "        public ");
            Write(ToStringHelper.ToStringWithCulture(File.Name));
            Write("(IdRequest request) : base(request)\r\n        {\r\n        }\r\n       \r\n\t\tprotected o" +
                  "verride async Task<Response> ProcessRequestAsync()\r\n        {\r\n\t\t\t\r\n            " +
                  "");
            if (File.HasContext && File.UseSoftDelete && File.Type.HasId)
            {
                ...
                Write(ToStringHelper.ToStringWithCulture(File.Type.Name));
                Write(
                    "Messages.NotFound);\r\n\r\n\t\t\t\tmodel.IsActive = false;\r\n\t\t\t\tresponse.NumberOfRowsEffe" +
                    "cted = await context.SaveChangesAsync();\r\n\t\t\t}\r\n\t\t\t");
            }
            Write("\r\n\t\t\t");
            if (File.HasContext && !File.UseSoftDelete && File.Type.HasId)
            {
                ...
                Write(
                    ...
                    "\r\n\t\t\t\t\tthrow new Exception(");
                Write(ToStringHelper.ToStringWithCulture(File.Type.Name));
                Write("Messages.NotFound);\r\n\r\n\t\t\t\tcontext.");
                Write(ToStringHelper.ToStringWithCulture(File.Type.PluralName));
                Write(".Remove(model);\r\n\t\t\t\t response.NumberOfRowsEffected = await context.SaveChangesAs" +
                      "ync();\r\n\t\t\t}\r\n\t\t\t");
            }
            Write("\t\t\tresponse.Message = ");
            Write(ToStringHelper.ToStringWithCulture(File.Type.Name));
            Write("Messages.DeleteOk;\r\n\t\t\treturn response;\r\n        }\r\n    }\r\n}\r\n");
    ...
    /// </summary>
    [GeneratedCode("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class DeleteCommandTemplateBase
    {
        #region Fields
