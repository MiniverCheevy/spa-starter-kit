...
namespace Voodoo.CodeGeneration.Templates.Logic.ProjectLevel.NameValuePairs
{
    ...
    public partial class ListsEnumTemplate : ListsEnumTemplateBase
    {
        /// <summary>
...
");
            ...
            Write("using Voodoo.Infrastructure.Notations;\r\n\r\nnamespace ");
            ...
            foreach (var name in File.Names)
            {
                ...
                Write("=");
                Write(ToStringHelper.ToStringWithCulture(counter));
                Write(",\r\n\t\t");
    ...
    /// </summary>
    [GeneratedCode("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class ListsEnumTemplateBase
    {
        #region Fields
