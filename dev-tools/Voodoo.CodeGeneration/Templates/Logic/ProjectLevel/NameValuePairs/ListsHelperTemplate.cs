...
foreach (var item in this.File.UsingStatements){
            ...
            this.Write(" context, Lists list, bool includeInactive = false)\r\n        {\r\n\t\t\t var response " +
...
if (item.Facade.HasSortOrder) {
            ...
            this.Write("=query");
            this.Write(this.ToStringHelper.ToStringWithCulture(item.DbSet.Name));
            this.Write(".OrderBy(c=>c.SortOrder).ThenBy(c=>c.Name);\r\n\t\t\t\t\t");
} else  {
            this.Write("\t\t\t\t\t\tquery");
            this.Write(this.ToStringHelper.ToStringWithCulture(item.DbSet.Name));
            this.Write("=query");
            this.Write(this.ToStringHelper.ToStringWithCulture(item.DbSet.Name));
            this.Write(".OrderBy(c=>c.Name);\r\n\t\t\t\t\t");
}
            this.Write("\t\t\t\t\t");
if (item.Facade.HasActiveFlag) {
            this.Write("\t\t\t\t\tif (!includeInactive)\r\n\t\t\t\t\t\tquery");
            this.Write(this.ToStringHelper.ToStringWithCulture(item.DbSet.Name));
            this.Write("=query");
            this.Write(this.ToStringHelper.ToStringWithCulture(item.DbSet.Name));
            this.Write(".Where(c=>c.IsActive);\r\n\t\t\t\t\t");
}
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(this.File.ContextName));
            this.Write(" context, ListsRequest request)\r\n\t\t{\r\n\t\t\tType enumType=null;\r\n\t\t\tvar response = n" +
                    "ew ListsResponse();\r\n\t\t\tvar items = new List<ListItem>();\r\n\t\t\t IList<IListItem> " +
                    "enumItems = new List<IListItem>();\r\n\t\t\t");
foreach (var item in this.File.NameValuePairTypes) {
            this.Write("\t\t\t\tif(request.Lists.Contains(Lists.");
            this.Write(this.ToStringHelper.ToStringWithCulture(item.EntityType.Name));
            this.Write("))\r\n\t\t\t\t{\r\n\t\t\t\t");
if (!item.IsEnum ) {
            this.Write("\t\t\t\t\tvar query");
            this.Write(this.ToStringHelper.ToStringWithCulture(item.DbSet.Name));
            this.Write(" = context.");
            this.Write(this.ToStringHelper.ToStringWithCulture(item.DbSet.Name));
            this.Write(".AsNoTracking().AsQueryable();\r\n\t\t\t\t\t");
if (item.Facade.HasSortOrder) {
            ...
            this.Write("\t\t\t\t\t");
if (item.Facade.HasActiveFlag) {
            this.Write("\t\t\t\t\tif (!request.IncludeInactive)\r\n\t\t\t\t\t\tquery");
            this.Write(this.ToStringHelper.ToStringWithCulture(item.DbSet.Name));
            this.Write("=query");
            this.Write(this.ToStringHelper.ToStringWithCulture(item.DbSet.Name));
            this.Write(".Where(c=>c.IsActive);\r\n\t\t\t\t\t");
