...
namespace Voodoo.CodeGeneration.Templates.Logic.ProjectLevel.NameValuePairs
{
    ...
    public partial class ListsResponseTemplate : ListsResponseTemplateBase
    {
        /// <summary>
...
foreach(var name in this.File.TypeNames){
            this.Write("\t\t\tpublic List<IListItem> ");
...
foreach(var name in this.File.TypeNames){
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class ListsResponseTemplateBase
    {
        #region Fields
