...
namespace Voodoo.CodeGeneration.Templates.Logic.ProjectLevel
{
    ...
    public partial class RestResourcesTemplate : RestResourcesTemplateBase
    {
        /// <summary>
...
foreach (var item in this.File.UsingStatements){
            ...
            this.Write("\r\n    {\r\n\t\t");
foreach(var item in this.File.Project.RestResources.Distinct().OrderBy(c=>c).ToArray()){
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class RestResourcesTemplateBase
    {
        #region Fields
