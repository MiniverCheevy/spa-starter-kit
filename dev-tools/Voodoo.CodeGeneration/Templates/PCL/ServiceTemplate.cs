...
public class ");
            ...
            {
                Write("\t\tpublic async Task<");
                Write(ToStringHelper.ToStringWithCulture(verb.ResponseTypeName));
                Write("> ");
                Write(ToStringHelper.ToStringWithCulture(verb.Name));
                Write("(");
                Write(ToStringHelper.ToStringWithCulture(verb.RequestTypeName));
                Write(" request)\r\n        {\r\n            var response = new ");
                Write(ToStringHelper.ToStringWithCulture(verb.ResponseTypeName));
                Write("();\r\n            try\r\n            {\r\n\r\n\t\t\t\tvar url = $@\"{IOC.ApiUrl}/");
                Write(ToStringHelper.ToStringWithCulture(File.Resource.Name));
