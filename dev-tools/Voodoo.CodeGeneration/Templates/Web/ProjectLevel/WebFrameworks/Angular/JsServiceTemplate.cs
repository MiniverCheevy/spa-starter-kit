...
(function () {
	...
	.module('app')
	.factory('");
            Write(ToStringHelper.ToStringWithCulture(File.JsName));
            Write("Factory\', [\'$http\',\'$log\', function($http,$log) {\r\n\r\n    var urlBase = \'api/");
            Write(ToStringHelper.ToStringWithCulture(File.JsName));
            Write("\';\r\n    var ");
            Write(ToStringHelper.ToStringWithCulture(File.JsName));
            Write("Factory = {};\r\n\r\n\t\t");
            foreach (var verb in File.Resource.Verbs)
            {
                ...
                {
                    Write("        var operation= $http.");
                    Write(ToStringHelper.ToStringWithCulture(verb.Name.ToLower()));
                    Write("(urlBase,request );\r\n\t\t");
                }
                else
                {
                    Write("\t\tvar operation= $http({url: urlBase, method:\'");
                    Write(ToStringHelper.ToStringWithCulture(verb.Name.ToLower()));
