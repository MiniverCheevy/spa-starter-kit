...
namespace Voodoo.CodeGeneration.Templates.Web.ProjectLevel.WebFrameworks.Angular
{
    ...
    public partial class JsServiceTemplate : JsServiceTemplateBase
    {
        /// <summary>
...
(function () {
	...
	.module('app')
	.factory('");
            this.Write(this.ToStringHelper.ToStringWithCulture(File.JsName));
            this.Write("Factory\', [\'$http\',\'$log\', function($http,$log) {\r\n\r\n    var urlBase = \'api/");
            this.Write(this.ToStringHelper.ToStringWithCulture(File.JsName));
            this.Write("\';\r\n    var ");
            this.Write(this.ToStringHelper.ToStringWithCulture(File.JsName));
            this.Write("Factory = {};\r\n\r\n\t\t");
...
if ( File.BodyVerbs.Contains(verb.Name.ToLower()) ) {
            this.Write("        var operation= $http.");
            this.Write(this.ToStringHelper.ToStringWithCulture(verb.Name.ToLower()));
            this.Write("(urlBase,request );\r\n\t\t");
} else {
            this.Write("\t\tvar operation= $http({url: urlBase, method:\'");
            this.Write(this.ToStringHelper.ToStringWithCulture(verb.Name.ToLower()));
...
");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class JsServiceTemplateBase
    {
        #region Fields
