...
namespace Voodoo.CodeGeneration.Templates.Scratch
{
    ...
    public partial class MappingTemplate : MappingTemplateBase
    {
        ...
        {
            Write(" public class ScratchFile \r\n {    \t\t\t\r\n        public  ");
            Write(ToStringHelper.ToStringWithCulture(File.Types.MessageType.Name));
            Write(" Map(");
            Write(ToStringHelper.ToStringWithCulture(File.Types.EntityType.Name));
            Write(" source, ");
            Write(ToStringHelper.ToStringWithCulture(File.Types.MessageType.Name));
            Write(" target )\r\n        {\r\n           ");
            ...
            {
                Write("\t\t\t\t\ttarget.");
                Write(ToStringHelper.ToStringWithCulture(item.Name));
                Write(" = source.");
                Write(ToStringHelper.ToStringWithCulture(item.Name));
                Write(";\r\n\t\t   ");
            }
