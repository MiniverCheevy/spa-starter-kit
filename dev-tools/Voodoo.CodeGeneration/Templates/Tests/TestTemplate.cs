...
foreach (var item in this.File.UsingStatements){
            ...
            this.Write(" \r\n    {\r\n         public static ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.File.Operation.RequestType.FullName));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(this.File.Operation.OperationTypeName));
            this.Write("(request);\r\n            var response = await command.ExecuteAsync();\r\n\r\n\t\t\trespon" +
                    "se.IsOk.Should().BeTrue();\r\n            response.Details.Should().BeEmpty();\r\n  " +
