...
namespace Voodoo.CodeGeneration.Templates.Tests
{
    ...
    public partial class TestHelperSaveTemplate : TestHelperSaveTemplateBase
    {
        /// <summary>
...
foreach (var item in this.File.UsingStatements){
            ...
            this.Write("Messages.AddOk);\r\n            response.IsOk.Should().BeTrue();\r\n\t\t    response.Ne" +
                    "wItemId.Should().NotBe(0);\r\n\t\t\t\r\n\t\t\tvar query = new ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.File.Type.Name));
            this.Write("DetailQuery(new IdRequest{Id =response.NewItemId});\r\n\t\t\tvar data= await query.Exe" +
                    "cuteAsync();\r\n\t\t\treturn data.Data;\t\t\t\r\n        }\r\n    }\r\n}\r\n");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class TestHelperSaveTemplateBase
    {
        #region Fields
