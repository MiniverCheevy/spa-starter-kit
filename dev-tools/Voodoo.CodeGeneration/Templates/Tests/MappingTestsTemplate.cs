...
namespace Voodoo.CodeGeneration.Templates.Tests
{
    ...
    public partial class MappingTestsTemplate : MappingTestsTemplateBase
    {
        /// <summary>
...
if (this.File.Type.HasId) {
            this.Write("\r\n            testHelper.Compare(source, message, new string[]{});\r\n\t\t\ttestHelper" +
                    ".Compare(target, message, new[] { \"Id\" });\r\n\t\t\t");
}else{
            this.Write("\r\n\t\t\ttestHelper.Compare(source, message, new string[]{});\r\n\t\t\ttestHelper.Compare(" +
                    "target, message, new string[]{});\r\n\t\t\t");
}
            this.Write("\r\n        }   \r\n\t\t");
...
if (this.File.Type.HasId) {
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class MappingTestsTemplateBase
    {
        #region Fields
