...
namespace Voodoo.CodeGeneration.Pluralizer
{
    ...
    internal class EnglishPluralizationService : PluralizationService, ICustomPluralizationMapping
    {
        ...
        public void AddWord(string singular, string plural)
        {
            ...
            {
                throw new ArgumentException($"The plural value '{plural}' already exists in the user-defined dictionary", "plural");
            }
            else if (this._userDictionary.ExistsInFirst(singular))
            {
                throw new ArgumentException($"The plural value '{singular}' already exists in the user-defined dictionary", "singular");
            }
            else
            {
